...
export default function Music() {
  return (
    <section id="music" className="px-12 py-32 relative"
        ...
        {RELEASES.map((r, i) => (
          <div key={r.id} className="group relative overflow-hidden reveal"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6"
              ...
              <div className="font-bebas text-2xl tracking-wide">{r.title}</div>
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 opacity-0 group-hover:opacity-100 transition-all duration-400"
              style={{ background: 'rgba(8,8,8,0.85)', transform: 'translateY(0.5rem)' }}
